...
/*
  This widget transitions between 3 images using a coin flip animation.
  For payment item;
  First child: Loading image
  Second Child: Success or Error icon
  Third child: Target image

  Loading image->Flip->Success/Error icon->Flip->Target image
*/
